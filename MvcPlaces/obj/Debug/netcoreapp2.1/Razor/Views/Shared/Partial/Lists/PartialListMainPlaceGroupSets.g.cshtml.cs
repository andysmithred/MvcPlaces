#pragma checksum "C:\Users\asmith\source\repos\MvcPlaces\MvcPlaces\Views\Shared\Partial\Lists\PartialListMainPlaceGroupSets.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1c46f5550795dcdab364458a17b78d3930037f23"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1c46f5550795dcdab364458a17b78d3930037f23", @"/Views/Shared/Partial/Lists/PartialListMainPlaceGroupSets.cshtml")]
    ...
    .Build(columns =>
    {
        ...
        columns.Add().Encoded(false).RenderedAs(model =>
            "<div class='btn-group float-right'>" +
                $"<a class='btn btn-dark btn-sm rounded-0' href='/PlaceGroupSet/Edit/{model.Id}'>Edit</a>" +
                $"<a class='btn btn-dark btn-sm rounded-0' href='/PlaceGroupSet/Details/{model.Id}'>Details</a>" +
                $"<a class='btn btn-dark btn-sm rounded-0' href='/PlaceGroupSet/Delete/{model.Id}'>Delete</a>" +
            "</div>"
        );
    })
    .Empty("No data found")
